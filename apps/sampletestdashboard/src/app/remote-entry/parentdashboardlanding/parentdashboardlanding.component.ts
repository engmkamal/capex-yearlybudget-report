...
@Component({
  selector: 'portal-parentdashboardlanding',
...
export class ParentdashboardlandingComponent implements OnInit, AfterViewInit {
          ...
          try {
            ...
            .subscribe(
              (items:any) => {
                ...
                allData = parsedData.filter((res:any)=>{return res.Title != null});
  ...
  async ngOnInit() {
    ...
    //   this.tg.rowData = [
    //     {"RequestID": "ITSR-12345", "RequestorEmployeeID": "1270"},
    //     {"RequestID": "ITSR-12346", "RequestorEmployeeID": "1270"},
    //     {"RequestID": "ITSR-12347", "RequestorEmployeeID": "1270"}
    //   ] 
